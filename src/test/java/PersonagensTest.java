...
@TestMethodOrder(MethodOrderer.OrderAnnotation.class)  // anotacao para garantir que os testes serao executados na ordem definida
public class PersonagensTest {

    private ObjectMapper mapper = new ObjectMapper(); // transforma JSON em obj e vice-versa
    ...
    @Test
    @Order(1)
    @DisplayName("Tentativa de criar personagens com dados inválidos")
